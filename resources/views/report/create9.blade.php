...
<div id="templatemo_wrapper">
    ...
    <form id="firstForm" method="POST" action="{{action('ReportController@store5')}}">
        ...
        <div id="templatmeo_menu">
            <p align="center">Опіки/ Переохолодження   {{$date}}</p>
            <input type="hidden" name="pidtype" value="opic">
        ...
        <div id="templatemo_main">
           <div id="home" class="main_box">
               <div class="col col-my">
                    ...
                    <form id="twoform" method="GET" action="{{action('ReportController@create10')}}">
